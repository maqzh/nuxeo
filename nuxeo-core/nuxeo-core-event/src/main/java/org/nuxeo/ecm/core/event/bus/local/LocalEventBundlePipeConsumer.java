...
import org.nuxeo.ecm.core.event.bus.AbstractEventBundlePipeConsumer;

/**
 *
 * @since TODO
 */
public class LocalEventBundlePipeConsumer extends AbstractEventBundlePipeConsumer<EventBundle> {
